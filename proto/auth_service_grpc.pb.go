...
func (c *authUsersServiceClient) GetUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
func (UnimplementedAuthUsersServiceServer) GetUser(context.Context, *GetUserRequest) (*User, error) {
